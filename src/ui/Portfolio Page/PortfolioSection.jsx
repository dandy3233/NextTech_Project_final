...
export default function PortfolioSection() {
  ...
  return (
    <div className="font-sans px-5 xs:px-6 md:px-12 lg:px-20 xl:px-20 2xl:px-24 py-12 xs:py-14 sm:py-16 md:py-20 lg:py-24">
      ...
      <div className="text-center mb-8 xs:mb-10 sm:mb-12 lg:mb-7">
        <p className="text-primary font-semibold text-base xs:text-lg lg:text-sm lg:ml-4 mb-4 uppercase ">
          Work with us
        </p>
        <h2 className="text-3xl xs:text-4xl md:text-5xl lg:text-4xl xl:text-4xl font-bold text-gray-900 mb-8 ">
          Our portfolio
        </h2>
      ...
      <div className="mb-10 sm:mb-14 md:mb-16 lg:mb-20 xl:mb-20 2xl:mb-20 sm:px-28 md:px-36 lg:px-48 xl:px-52 2xl:px-56 flex justify-center">
        <div
          ref={scrollRef}
        ...
        >
          {projectCategories.map((category) => (
            <button
              ...
              className={`flex-none px-4 xs:px-5 sm:px-6 md:px-7 lg:px-8 xl:px-6 2xl:px-7 py-2.5 xs:py-3 sm:py-3.5 md:py-4 lg:py-4.5 xl:py-3 text-sm xs:text-base sm:text-base md:text-lg lg:text-xl font-semibold whitespace-nowrap rounded-full transition-all duration-500 ease-in-out snap-center ${selectedCategory === category
...
//   // 3. SMART AUTO-SCROLL (Forward and Backward)
//   useEffect(() => {
//     const index = projectCategories.indexOf(selectedCategory);
//     const container = scrollRef.current;
...
//           (item) => item.catagory === selectedCategory
//         );
//   }, [selectedCategory, portfolioProjects]);
...
//                 setCurrentPage(1)
//               }}
//               className={`flex-none px-4 xs:px-5 sm:px-6 md:px-7 lg:px-8 xl:px-6 2xl:px-7 py-2.5 xs:py-3 sm:py-3.5 md:py-4 lg:py-4.5 xl:py-3 text-sm xs:text-base sm:text-base md:text-lg lg:text-xl font-semibold whitespace-nowrap rounded-full transition-all duration-500 ease-in-out snap-center ${
